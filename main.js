...
let dessertsData = [
    ...
    { id: 4, name: "Мороженое Магнат", price: 525, count: 0, status: "", description: "Элитное мороженое в шоколаде.", img: "./img/blochka.png" },
    { id: 5, name: "Мороженое Магнат", price: 525, count: 0, status: "", description: "Элитное мороженое в шоколаде.", img: "./img/marojini-4.png" },
